...
public class SelectionPortalContentMap extends SelectionPortalContent {
	...
	public SelectionPortalContentMap(SelectionPortalPanel selectionPortalPanel, int widthPortlet, int heightPortlet, String type, String title) {
		...
		panelCentral.setScrollMode(Scroll.AUTO);
...
//	    panelPortlet.add(buildPortletHtmlPanel());
	...
	private ContentPanel buildCentralInfoPanel() {
		...
		centralInfoPanel.setHeight(450);
//		portletInfoPanel.setHeaderVisible(false);
		centralInfoPanel.setHeading("Central Intersactions");
...
//		portletInfoPanel.setHeaderVisible(false);
		portletInfoPanel.setHeading("Intersactions");
