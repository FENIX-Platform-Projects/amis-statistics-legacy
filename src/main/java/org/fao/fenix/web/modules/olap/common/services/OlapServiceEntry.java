...
public class OlapServiceEntry {

	private static OlapServiceAsync olapService = null;

	public static OlapServiceAsync getInstance() {
		if (olapService == null) {
			FenixServiceEntryPoint ep = new FenixServiceEntryPoint();
			String urlOlap = ep.getServiceEntryPointOlap(GWT.getModuleBaseURL(), GWT.getModuleName());
			olapService = (OlapServiceAsync) GWT.create(OlapService.class);
