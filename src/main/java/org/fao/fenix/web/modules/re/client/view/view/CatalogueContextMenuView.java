...
import org.fao.fenix.web.modules.re.client.control.view.CatalogueContextMenuViewController;
...
public class CatalogueContextMenuView extends CatalogueContextMenu {

	public CatalogueContextMenuView(ResourceExplorer explorer, Catalogue catalogue) {
	...
	public Menu buildMenu() {
		...
		open.addSelectionListener(CatalogueContextMenuViewController.open(catalogueGrid));
