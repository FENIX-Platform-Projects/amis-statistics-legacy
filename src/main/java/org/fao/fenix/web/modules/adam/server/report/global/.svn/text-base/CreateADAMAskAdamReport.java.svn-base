...
public class CreateADAMAskAdamReport {
	...
	public CreateADAMAskAdamReport(ADAMReportBeanVO adamReportBean, ReportDesignHandle designHandle, ElementFactory designFactory ){
	...
	public void build() throws SemanticException {
		...
		new DesignUtils().addSpace(designHandle);
		new DesignUtils().addSpace(designHandle);
		new CreateADAMAskAdamBody(adamReportBean, designHandle, designFactory).build();
