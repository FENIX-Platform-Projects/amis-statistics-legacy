...
public class IPCReportsPanel {
	...
	public Button openIPC = new Button("Create IPC Report");
	
	private String firstWidth = "150px";
	
	
	public IPCReportsPanel() {
	...
	private void enanche(){
		openIPC.addSelectionListener(CreateIPCReportController.createIPCSummaryReport(this, grid));
	}
	...
	public ContentPanel buildGridPanel(){
		...
		column = new ColumnConfig();  
		column.setId("moderatorFullName");  
		column.setHeader("Moderator");  
		column.setWidth(100);
		configs.add(column);
...
//		panel.setBodyBorder(true);    
	...
	private ChangeListener fillGrid(final IPCReportsPanel tab) {
