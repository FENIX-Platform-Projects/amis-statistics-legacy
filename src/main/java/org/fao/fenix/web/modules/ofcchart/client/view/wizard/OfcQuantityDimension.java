...
public class OfcQuantityDimension {
	...
	public OfcQuantityDimension(long datasetId, ListBox dimensionSel, ListBox dimensionNoSel, VerticalPanel otherDimensions, List<String> otherDim){
		...
		ok.addSelectionListener(new SelectionListener<ButtonEvent>(){
			...
			public void componentSelected(ButtonEvent ce){
				...
				for (int i=0; i<OfcQuantityDimension.this.otherDim.size(); i++){
					if (OfcQuantityDimension.this.otherDim.get(i).equals(selDim)){
						OfcQuantityDimension.this.otherDim.remove(i);
						break;
					}
				}
				
				ChartWizardController.fillOtherDimensionYEvent(OfcQuantityDimension.this.datasetId, OfcQuantityDimension.this.dimensionSel, OfcQuantityDimension.this.dimensionNoSel, OfcQuantityDimension.this.otherDimensions, OfcQuantityDimension.this.otherDim);
				window.close();
