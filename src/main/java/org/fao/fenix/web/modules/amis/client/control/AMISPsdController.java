...
import org.fao.fenix.web.modules.amis.client.view.home.AMISPsdPanel;
...
public class AMISPsdController {
...
//	}
  ...
  public static void getVOs(final AMISPsd visualization, final AMISPsdPanel panel, final AMISSettingsVO settings) {

		//System.out.println("getVOs() START selectedProduct "+ visualization.getSelectedProduct());

		if(visualization.getSelectedProduct()!=null){

			System.out.println("getVOs() START selectedProduct "+ visualization.getSelectedProduct().getLabel());
		}
		try{
	    	 AMISServiceEntry.getInstance().getAMISQueryVOs(AMISCurrentView.HOME, AMISConstants.PSD.name(), new AsyncCallback<AMISSettingsVO>() {
					...
					public void onSuccess(AMISSettingsVO vo) {
						...
						for(AMISQueryVO qvo : qvos) {
							...
							exportTitle += " (AMIS Statistics Source: USDA-PSD)";
  ...
  public static void buildFilters(AMISPsd visualization, List<AMISFilterVO> filters, AMISCodesModelData code) {
  ...
  /** TODO: remove the combo parameter, and selected codes etc...pass filter **/
	public static SelectionChangedListener<AMISCodesModelData> updateFilter(final AMISPsd visualization, final AMISFilter filter, final ComboBox<AMISCodesModelData> combo, final String filterType, final AMISCodesModelData domaincode, final HashMap<String, String> selectedCodes) {
		return new SelectionChangedListener<AMISCodesModelData>() {
			public void selectionChanged(SelectionChangedEvent<AMISCodesModelData> se) {
...
public static void updateFilterAgent(AMISPsd visualization, AMISFilter filter, ComboBox<AMISCodesModelData> combo, String filterType, AMISCodesModelData domaincode, HashMap<String, String> selectedCodes) {
...
private static void multiselectionFilterAgent(final AMISPsd visualization, final AMISFilter filter, final String filterTypeMultisel, final AMISCodesModelData code) {
	filter.getMultiselection().build(visualization, filter, filterTypeMultisel, code);
}

public static SelectionListener<ButtonEvent> updateMultiselectionFilter(final Window window, final AMISPsd visualization, final AMISFilter filter, final List<AMISMultiselectionItem> multiSelectionItems, final String filterType, final AMISCodesModelData code, final HashMap<String, String> selectedCodes) {
...
private static void updateMultiselectionFilterAgent(Window window, final AMISPsd visualization, AMISFilter filter, List<AMISMultiselectionItem> multiSelectionItems, final String filterType, final AMISCodesModelData code, final HashMap<String, String> selectedCodes) {
	...
	public static void loadCodingSystem(final AMISPsd visualize, final ComboBox<AMISCodesModelData> combo, final ListStore<AMISCodesModelData> store, final String filterType, AMISCodesModelData code)  {
...
public static void buildViews(ContentPanel panel, List<AMISQueryVO> qvos, String title) {
	System.out.println("buildViews Start psd!!!!!!!!!!!!!!!!!! ");
		panel.removeAll();
		if(qvos!=null)
		{
			for(AMISQueryVO qvo: qvos)
			{
				if(qvo!=null)
				{
					...
					{
						System.out.println("buildViews Start psd remove!!!!!!!!!!!!!!!!!! ");
						qvos.remove(qvo);
						break;
					}
				}
...
public static SelectionListener<IconButtonEvent> multiselectionFilter(final AMISPsd visualization, final AMISFilter filter, final String filterTypeMultisel, final AMISCodesModelData code) {
