...
public class TabAxes extends TabItem {
	...
	CheckBox xGrid;
	TextField<String> rotateXLabels;
	
	StylePanel xAxisLabelStylePanel;
	
	StylePanel xAxisStylePanel;
	...
	private FieldSet createXAxisTitleWidgets(){
		...
		xAxisLabelStylePanel = new StylePanel();
		fieldSet.add(xAxisLabelStylePanel.buildVerticalPanel(false, false, false, "Arial"));
	...
	private FieldSet createXAxisLabelWidgets(){
		...
		HTML html = new HTML(BabelFish.print().rotateLabels() + ": ");
		html.setWidth("55px");
		hr.add(html);
		rotateXLabels = new TextField<String>();
		rotateXLabels.setValue("45");
		hr.add(rotateXLabels);
		
		fieldSet.add(hr);
		
		xAxisStylePanel = new StylePanel();
		fieldSet.add(xAxisStylePanel.buildVerticalPanel(false, false, false, "Arial"));
...
// -------------------- Y axis -----------------------------------
	...
	StylePanel yAxisTitleStylePanel;
	
	StylePanel yAxisStylePanel;
	...
	private FieldSet createYAxisTitleWidgets(){
		...
		fieldSet.add(hrcolorYAxisTitle);
		 ...
		 yAxisTitleStylePanel = new StylePanel();
		 fieldSet.add(yAxisTitleStylePanel.buildVerticalPanel(true, false, false, "Arial"));
	...
	private FieldSet createYAxisLabelWidgets(){
		...
		fieldSet.add(hrYGrid);
		 ...
		 yAxisStylePanel = new StylePanel();
		 fieldSet.add(yAxisStylePanel.buildVerticalPanel(false, false, false, "Arial"));
...
// -------------------- Y axis  (Second Scale) -----------------------------------
	...
	StylePanel yAxis2TitleStylePanel;
	
	StylePanel yAxis2StylePanel;
	...
	private FieldSet createY2AxisTitleWidgets(){
		...
		fieldSet.add(hrcolorY2AxisTitle);
		 ...
		 yAxis2TitleStylePanel = new StylePanel();
		 fieldSet.add(yAxis2TitleStylePanel.buildVerticalPanel(false, false, false, "Arial"));
	...
	private FieldSet createY2AxisLabelWidgets(){
		...
		fieldSet.add(hrcolorY2AxisLabel);
		 ...
		 yAxis2StylePanel = new StylePanel();
		 fieldSet.add(yAxis2StylePanel.buildVerticalPanel(false, false, false, "Arial"));
	...
	public TabAxes(){
		...
		TabItem xTab = new TabItem("X-Axis");
		TabItem yTab = new TabItem("Y-Axis");
		xTab.setAutoWidth(true);
		yTab.setAutoWidth(true);
...
//		xAxis.setScrollMode(Scroll.AUTO);
		...
		vpXAxis.setHeight(340);
		vpXAxis.setWidth(580);
		vpXAxis.setScrollMode(Scroll.AUTO);
...
//		yAxis.setScrollMode(Scroll.AUTO);
		...
		vpYAxis.setHeight(340);
		vpYAxis.setWidth(580);
		vpYAxis.setScrollMode(Scroll.AUTO);
...
//		yAxis.setExpanded(false);
		
//		mainCont.add(yAxis);
		
		add(mainCont);
		
		panel.add(xTab, "X-Axis");
		panel.add(yTab, "Y-Axis");
		add(panel);
	...
	public TextField<String> getRotateXLabels() {
		return rotateXLabels;
	}

	public StylePanel getxAxisLabelStylePanel() {
		return xAxisLabelStylePanel;
	}

	public StylePanel getxAxisStylePanel() {
		return xAxisStylePanel;
	}

	public StylePanel getyAxisTitleStylePanel() {
		return yAxisTitleStylePanel;
	}

	public StylePanel getyAxisStylePanel() {
		return yAxisStylePanel;
	}

	public StylePanel getyAxis2TitleStylePanel() {
		return yAxis2TitleStylePanel;
	}

	public StylePanel getyAxis2StylePanel() {
		return yAxis2StylePanel;
	}
