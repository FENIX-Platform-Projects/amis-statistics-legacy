...
public class ShowIPCWorkflowTab {
	...
	private Button deleteWF = new Button("Delete Workflow");
	

	
	public Button openIPC = new Button("Open Workflow");
	
	private String firstWidth = "150px";
	
	private WorkflowInfoVO workflowInfo;
	
	
	public ShowIPCWorkflowTab() {
		panel = new ContentPanel();
		openIPC.setSize(40, 25);
		deleteWF.setSize(40, 25);
		workflowInfo = new WorkflowInfoVO();
	}
	...
	private void enanche(IPCWorkflowWindow window){
		openIPC.addSelectionListener(CreateIPCWorkflowController.openWorkflow(window, this, grid));
		deleteWF.addSelectionListener(CreateIPCWorkflowController.deleteWorkflow(this, grid));
	}
...
//		panel.setBodyBorder(true);    
	...
	private ChangeListener fillGrid(final ShowIPCWorkflowTab tab) {
		ChangeListener t = new ChangeListener() {  
			public void onChange(Widget sender) {
				CreateIPCWorkflowController.fillLoadGrid(tab);
	...
	public WorkflowInfoVO getWorkflowInfo() {
		return workflowInfo;
	}



	public void setWorkflowInfo(WorkflowInfoVO workflowInfo) {
