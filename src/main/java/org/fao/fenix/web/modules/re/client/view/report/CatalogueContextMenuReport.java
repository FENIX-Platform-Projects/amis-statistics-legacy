...
import org.fao.fenix.web.modules.re.client.control.report.CatalogueContextMenuReportController;
...
public class CatalogueContextMenuReport extends CatalogueContextMenu {

		public CatalogueContextMenuReport(ResourceExplorer explorer, Catalogue catalogue){
		 ...
		 public Menu buildMenu() {	
				...
				open.addSelectionListener(CatalogueContextMenuReportController.open(catalogueGrid));
