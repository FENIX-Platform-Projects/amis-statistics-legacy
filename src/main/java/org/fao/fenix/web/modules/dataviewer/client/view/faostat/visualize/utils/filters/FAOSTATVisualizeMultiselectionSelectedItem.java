...
public class FAOSTATVisualizeMultiselectionSelectedItem {
	...
	FAOSTATVisualizeMultiselectionFilter filterPanel;
	
	public FAOSTATVisualizeMultiselectionSelectedItem(FAOSTATVisualizeMultiselectionFilter filterPanel) {
