...
public class AMISCcbs extends AMISDatasource {

	    AMISCcbsPanel ccbsPanel;
	    AMISCodesModelData selectedProduct;
	    
	    
		public AMISCcbs() {
			super();
			ccbsPanel = new AMISCcbsPanel();
		}
		
//		public AMISCcbs(AMISMainMenu mainMenu) {
//			super();
//			ccbsPanel = new AMISCcbsPanel();
