...
public class CatalogueContextMenuOlap extends CatalogueContextMenu {

	public CatalogueContextMenuOlap(ResourceExplorer explorer, Catalogue catalogue) {
	...
	public Menu buildMenu() {
		...
		open.addSelectionListener(CatalogueContextMenuOlapController.open(catalogueGrid));
