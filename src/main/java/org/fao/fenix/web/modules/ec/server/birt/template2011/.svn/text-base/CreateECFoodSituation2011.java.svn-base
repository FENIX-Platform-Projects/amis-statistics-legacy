...
public class CreateECFoodSituation2011 {
...
//	String textFontSize = "9.5pt";
	...
	public CreateECFoodSituation2011(ECBean ecBean, ReportDesignHandle designHandle, ElementFactory designFactory ){
	...
	public GridHandle buildFAOFoodSituation() throws SemanticException {
		...
		text = designHandle.getElementFactory().newTextItem("");
		text = DesignUtils.createText(designHandle, text, foodSituationFontSize, "center");
		text.setContent("<div><a href='http://www.fao.org/giews/english/cpfs/index.htm'>FAO/GIEWS</a>CPFS 2011</div>");
//		text.setContent("<div><a href='http://www.fao.org/giews/english/hotspots/index.htm'>FAO/GIEWS</a>CPFS 2010</div>");
		gridCellHandle.getContent().add(text);
...
//		text.setContent("<div><a href='http://content.yudu.com/Library/A1p89k/2010GlobalHungerInde/resources/index.htm?referrerUrl=http%3A%2F%2Fwww.ifpri.org%2Fpublication%2F2010-global-hunger-index'>IFPRI/2010</a> GHI</div>");
	
		text.setContent("<div><a href='http://www.ifpri.org/sites/default/files/publications/ghi11.pdf'>IFPRI/2011</a> GHI</div>");
