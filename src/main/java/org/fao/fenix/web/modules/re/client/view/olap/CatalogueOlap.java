...
public class CatalogueOlap extends CatalogueSimple {

	public CatalogueOlap(ResourceExplorer resourceExplorer) {
		...
		grid.addListener(Events.CellDoubleClick, CatalogueOlapController.onDoubleClick(resourceExplorer));
		CatalogueController.fillGrid(resourceExplorer, grid, fenixSearchParameters, resourceExplorer.getCataloguePager(), this);
		grid.setContextMenu(new CatalogueContextMenuOlap(resourceExplorer, this).buildMenu());
	}
