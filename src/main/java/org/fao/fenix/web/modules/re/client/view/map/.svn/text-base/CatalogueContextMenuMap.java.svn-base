...
import org.fao.fenix.web.modules.re.client.control.map.CatalogueContextMenuMapController;
...
public class CatalogueContextMenuMap extends CatalogueContextMenu {

		public CatalogueContextMenuMap(ResourceExplorer explorer, Catalogue catalogue){
		 ...
		 public Menu buildMenu() {	
				...
				open.addSelectionListener(CatalogueContextMenuMapController.open(catalogueGrid));
