...
public class CreateECSecondPageVegetationCondition {
	...
	public CreateECSecondPageVegetationCondition(ECBean ecBean, ReportDesignHandle designHandle, ElementFactory designFactory ){
