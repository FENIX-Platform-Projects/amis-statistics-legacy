...
import org.fao.fenix.web.modules.amis.server.FoodBalanceQueryBuilder;
    ...
    private int createDataRows(int rowCounter, HSSFSheet sheet, HSSFWorkbook workbook, String country, String label, String datasource, Map<String, String> datesMap, LinkedHashMap<String, String> elementsMap, LinkedHashMap<String, LinkedHashMap<String, Map<String, Double>>> resultsMap, String title,  AMISQueryVO qvo){
       ...
       // HSSFCellStyle cellStyle = workbook.createCellStyle();
        ...
        for(String elementCode: elementsMap.keySet()){
            ...
            if(FoodBalanceQueryBuilder.FOOD_BALANCE_ELEMENTS_HIGHLIGHTED.contains(elementCode)){
                elementName = elementName.toUpperCase();
                elementCellStyle.setFont(AMISSupplyDemandExcelUtils.boldFont);
            }

            //Apply first indentation
            if(FoodBalanceQueryBuilder.FOOD_BALANCE_ELEMENTS_INDENTED.contains(elementCode)){
               elementCellStyle.setFont(AMISSupplyDemandExcelUtils.italicFont);
                elementName = "     "+elementName;
            }

            //Append a second indentation
            if(FoodBalanceQueryBuilder.FOOD_BALANCE_ELEMENTS_MORE_INDENTED.contains(elementCode) && otherUsesPresent){
                ...
                if(year.get(date)!=null) {
                    ...
                    if(year.get(date).get(elementCode)!=null){
                        ...
                        if(elementCode.equals("35") || elementCode.equals("19"))    {
                            ...
                            if(otherUsesPresent){
                                if(FoodBalanceQueryBuilder.FOOD_BALANCE_ELEMENTS_MORE_INDENTED.contains(elementCode)){
