...
import org.fao.fenix.web.modules.amis.common.vo.AMISDBVO;

import com.google.gwt.user.client.rpc.IsSerializable;

public class AMISQueryVO extends AMISDBVO implements IsSerializable{
	...
	private AMISCalculationParametersVO calculationParametersVO;
   ...
   // private LinkedHashMap<String,  List<String>> nationalDataSources;
	...
	public AMISCalculationParametersVO getCalculationParametersVO() {
		return calculationParametersVO;
	}

	public void setCalculationParametersVO(
			AMISCalculationParametersVO calculationParametersVO) {
	...
	public AMISQueryVO createCopy()
	{
		...
		qvoNew.setCalculationParametersVO(qvo.getCalculationParametersVO());
		...
		qvoNew.setDbUserName(qvo.getDbUserName());
		qvoNew.setConnectionString(qvo.getConnectionString());
		qvoNew.setDbPassword(qvo.getDbPassword());
		...
		qvoNew.setConnectionDriver(qvo.getConnectionDriver());
		qvoNew.setCountryCode(qvo.getCountryCode());
		qvoNew.setCountryCode(qvo.getCountryCode());
		qvoNew.setDatasetCodes(qvo.getDatasetCodes());
		qvoNew.setDatasetTableName(qvo.getDatasetTableName());
		qvoNew.setDatasource(qvo.getDatasource());
		qvoNew.setDbDriver(qvo.getDbDriver());
		qvoNew.setDbName(qvo.getDbName());
		qvoNew.setDbServerName(qvo.getDbServerName());
		qvoNew.setDbUrl(qvo.getDbUrl());
		...
		qvoNew.setLanguage(qvo.getLanguage());
