...
public class CatalogueView extends CatalogueSimple {

	public CatalogueView(ResourceExplorer resourceExplorer) {
		...
		grid.addListener(Events.CellDoubleClick, CatalogueViewController.onDoubleClick(resourceExplorer));
		CatalogueController.fillGrid(resourceExplorer, grid, fenixSearchParameters, resourceExplorer.getCataloguePager(), this);
		grid.setContextMenu(new CatalogueContextMenuView(resourceExplorer, this).buildMenu());
	}
