...
public class CatalogueContextMenuImage extends CatalogueContextMenu {

	public CatalogueContextMenuImage(ResourceExplorer explorer, Catalogue catalogue) {
	...
	public Menu buildMenu() {
		...
		open.addSelectionListener(CatalogueContextMenuImageController.open(catalogueGrid));
