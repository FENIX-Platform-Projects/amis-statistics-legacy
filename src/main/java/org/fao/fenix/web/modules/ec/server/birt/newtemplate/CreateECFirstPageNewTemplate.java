...
public class CreateECFirstPageNewTemplate {
...
//	String conflictsHeight = "12.9cm";
	...
	public CreateECFirstPageNewTemplate(ECBean ecBean, ReportDesignHandle designHandle, ElementFactory designFactory ){
...
//			text.setContent("<div style='font-style: italic;'> Undernourished Population - " + ecBean.getSocialEconomicBean().getFAO1().getDate() + " ("+ ecBean.getSocialEconomicBean().getFAO1().getSource() +") </div>");
			// HARDCODED DATE
			text.setContent("<div style='font-style: italic;'> Undernourished Population - 2005/2007 ("+ ecBean.getSocialEconomicBean().getFAO1().getSource() +") </div>");
		else
			text.setContent("<div style='font-style: italic;'> Undernourished Population - 2005/2007 (FAO) </div>");
		DesignUtils.setBorderGrid(gridCellHandle, tableBorder);
		gridCellHandle.getContent().add(text);
...
//		tableGridHandle.setProperty(GridHandle.WIDTH_PROP, "100%");
	...
	private GridHandle createConflictsTables() throws SemanticException {
		...
		CreateECFirstPageConflictsNewTemplate reportUtils = new CreateECFirstPageConflictsNewTemplate(ecBean, designHandle, designFactory);
...
//		gridCellHandle.getContent().add(reportUtils.buildDisastersTable(gridCellHandleSource));
