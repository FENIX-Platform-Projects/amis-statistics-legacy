...
public class CatalogueLayer extends CatalogueSimple {

	public CatalogueLayer(ResourceExplorer resourceExplorer){
		...
		grid.addListener(Events.CellDoubleClick, CatalogueLayerController.onDoubleClick(resourceExplorer));
	
		// fill the table
		CatalogueController.fillGrid(resourceExplorer, grid, fenixSearchParameters, resourceExplorer.getCataloguePager(), this);

		// add context menu
		grid.setContextMenu(new CatalogueContextMenuLayer(resourceExplorer, this).buildMenu());		
	}
}
