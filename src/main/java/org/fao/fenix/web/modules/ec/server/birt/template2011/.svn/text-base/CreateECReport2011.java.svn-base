...
public class CreateECReport2011 {
	...
	public CreateECReport2011(ECBean ecBean) {
		this.ecBean = ecBean;
	}
	...
	public String createECReport(Boolean exportPDF) {
		...
		//			createECSecondPage.build();
					...
					CreateECFirstPage2011 createECFirstPage = new CreateECFirstPage2011(ecBean, designHandle, designFactory);
					createECFirstPage.build();
					CreateECSecondPage2011 createECSecondPage = new CreateECSecondPage2011(ecBean, designHandle, designFactory);
					createECSecondPage.build();
