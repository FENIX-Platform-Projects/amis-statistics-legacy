		     ...
		     $('#'+chart_div_id).append('<div style="text-align:center"><img src="http://statistics.amis-outlook.org/data/amis-market-monitor/images/loading-chart.gif"/></div>');
    	 	    ...
    	 	    function next() {
    	 	         ...
    	 	         if (index < indicatorsArray.length ) {
    	 	             ...
    	 	             var urlNew = "http://statistics.amis-outlook.org/data/amis-market-monitor/jsp/"+server_script_name+".jsp?indicatorcode="+indicatorcode + "&domaintablecode="+domain_table_code+"&timespan="+timeSpan+"&callback=?";
