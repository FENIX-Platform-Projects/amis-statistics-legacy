	 		        ...
	 		        $.ajax({
	 			     ...
	 			     contentType: "application/json",
	 		             ...
	 		             success:    function(jsondata) {	
	    		              ...
	    		              createChart(jsondata.product_name + " "+ jsondata.prod_name, time_period, productionChartData, 'chart_production', jsondata.prod_unit);
	    		              
	    		              var importChartData= createChartData(importsData.amis_imports_data, importsData.non_amis_imports_data);
	    		              createChart(jsondata.product_name + " "+ jsondata.import_name, time_period, importChartData, 'chart_imports', jsondata.import_unit);
	    		             
	    		              var exportChartData= createChartData(exportsData.amis_exports_data, exportsData.non_amis_exports_data);
	    		              createChart(jsondata.product_name + " "+ jsondata.export_name, time_period, exportChartData, 'chart_exports', jsondata.export_unit);
