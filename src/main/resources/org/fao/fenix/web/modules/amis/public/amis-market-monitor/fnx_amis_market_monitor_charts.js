(function () {
    ...
    function loadEthanolCharts(){
        ...
        if ($("#amis_mm_e_chart_EPCA").length > 0){
            model =   new MarketMonitorDomainModel('US ethanol production pace, capacity and annual mandate', '11', 'AMIS_ETHANOL_CAPACITY_MONTHLY_INDICATORS', 'AMIS-STATISTICS', ['ETHP','ETHMA', 'ETHCAP'], null, 'amis-mm-other-indicators');
            view = new MarketMonitorChartView(model, {
                'chartDivId' : 'amis_mm_e_chart_EPCA',
                'chartSessionId' : 'EPCA',
                'chartRangeSelectorButtons': ['YTD','1y','5y','all'],
                'seriesColours': ['#2A5AA6', '#DD3218', '#07A02E'], //blue, red, green
                'chartShowDateInputBoxes' : false
            });
        ...
        if ($("#amis_mm_e_chart_EPCA_1").length > 0){
            ...
            view = new MarketMonitorChartView(model, {
                'chartDivId' : 'amis_mm_e_chart_EPCA_1',
                'chartSessionId' : 'EPCA_1',
                'chartRangeSelectorButtons': ['YTD','1y','5y','all'],
        ...
        if ($("#amis_mm_e_chart_EPCA_2").length > 0){
            model =   new MarketMonitorDomainModel('US Ethanol Production Pace, Capacity and Annual Mandate', '11', 'AMIS_ETHANOL_CAPACITY_MONTHLY_INDICATORS', 'AMIS-STATISTICS', ['ETHP','ETHMA', 'ETHCAP', 'ETHMAP'], null, 'amis-mm-other-indicators');
            view = new MarketMonitorChartView(model, {
                'chartDivId' : 'amis_mm_e_chart_EPCA_2',
                'chartSessionId' : 'EPCA_2',
                'chartRangeSelectorButtons': ['YTD','1y','5y','all'],
                'seriesColours': ['#2A5AA6', '#DD3218', '#07A02E', '#DD3218'], //blue, red, green, red,
                'seriesLineStyle': [{'ETHMAP':'Dash'}],
                'chartShowDateInputBoxes' : false,
