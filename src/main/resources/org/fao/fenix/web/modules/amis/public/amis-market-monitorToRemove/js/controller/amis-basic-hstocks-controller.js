...
BasicHighStocksController.prototype = {
    ...
    getDataAndCharts : function(indicatorsArray) {
     ...
     indicatorsIterator(index, domain_source, seriesOptions, current_view, "OUTER_NEXT", indicatorsArrayLength, indicatorsArray, indicatormarkets, timeSpan, unitArray, domaintablecode, server_script_name, sourceArray, sourceUrlArray, seriescolors, isCompareTimeChart);
...
function indicatorsIterator(index, domain_source, seriesOptions, current_view, calledFrom, indicatorsArrayLength, indicatorsArray, indicatormarkets, timeSpan, unitArray, domaintablecode, server_script_name, sourceArray, sourceUrlArray, seriescolors, isTimeComparisonChart) {
    ...
    if (index < indicatorsArrayLength ) {
        ...
        if(domain_source == 'AMIS-STATISTICS' || domain_source == 'FAO-EST'){
           ...
           if(indicatormarkets!=null)
               ajaxUrl += "&marketcode="+indicatormarkets[index]+"&callback=?";//urlNew += "&marketcode="+indicatormarkets[index]+"&callback=?";
           else
               ajaxUrl += "&callback=?";

            if(isTimeComparisonChart)
                makeAMISCompareAjaxCall(index, domain_source, ajaxUrl, indicatorcode, current_view, timeSpan, domaintablecode, server_script_name, indicatormarkets, indicatorsArray, unitArray, sourceArray, sourceUrlArray, seriescolors, seriesvisibility, seriesOptions, indicatorsArrayLength, isTimeComparisonChart);
            else
            makeAMISAjaxCall(index, domain_source, ajaxUrl, indicatorcode, current_view, timeSpan, domaintablecode, server_script_name, indicatormarkets, indicatorsArray, unitArray, sourceArray, sourceUrlArray, seriescolors, seriesvisibility, seriesOptions, indicatorsArrayLength, isTimeComparisonChart);


        } else if(domain_source=='FRED'){
            ajaxUrl = "http://fenixapps.fao.org/fenix-fred/rest/series/"+indicatorcode+"/data";

            makeFREDAjaxCall(index, domain_source, ajaxUrl, indicatorcode, current_view, timeSpan, domaintablecode, server_script_name, indicatormarkets, indicatorsArray, unitArray, sourceArray, sourceUrlArray, seriescolors, seriesvisibility, seriesOptions, indicatorsArrayLength, isTimeComparisonChart);
...
function makeAMISAjaxCall(index, domain_source, url, indicatorcode, current_view, timeSpan, domaintablecode, server_script_name, indicatormarkets, indicatorsArray, unitArray, sourceArray, sourceUrlArray, seriescolors, seriesvisibility, seriesOptions, indicatorsArrayLength, isTimeComparisonChart){

    $.ajax({
        type:       "GET",
        url:        url,
        async: false,
        jsonpCallback: 'jsonCallback'+indicatorcode,
        dataType: 'jsonp',
        success:    function(jsondata) {
            ...
            indicatorsIterator(index, domain_source, seriesOptions, current_view, "ONSUCCESS_NEXT", indicatorsArrayLength, indicatorsArray, indicatormarkets, timeSpan, unitArray, domaintablecode, server_script_name, sourceArray, sourceUrlArray, seriescolors, isTimeComparisonChart)
        ...
        error: function (request, status, error) {
            ...
            indicatorsIterator(index, domain_source, seriesOptions, current_view, "ONFAILURE_NEXT", indicatorsArrayLength, indicatorsArray, indicatormarkets, timeSpan, unitArray, domaintablecode, server_script_name, sourceArray, sourceUrlArray, seriescolors, isTimeComparisonChart)
...
function makeAMISCompareAjaxCall(index, domain_source, url, indicatorcode, current_view, timeSpan, domaintablecode, server_script_name, indicatormarkets, indicatorsArray, unitArray, sourceArray, sourceUrlArray, seriescolors, seriesvisibility, seriesOptions, indicatorsArrayLength, isTimeComparisonChart){

    $.ajax({
        type:       "GET",
        url:        url,
        async: false,
        jsonpCallback: 'jsonCallbackCompare'+indicatorcode,
        dataType: 'jsonp',
...
function makeFREDAjaxCall(index, domain_source, url, indicatorcode, current_view, timeSpan, domaintablecode, server_script_name, indicatormarkets, indicatorsArray, unitArray, sourceArray, sourceUrlArray, seriescolors, seriesvisibility, seriesOptions, indicatorsArrayLength, isTimeComparisonChart){
