	...
	************************************************************************************************************/	
	...
	var form_widget_amount_slider_handle = '../theme/OWSManager/images/slider_handle.gif';
		...
		do{			
			if(subDiv.tagName=='DIV' && subDiv.className!='colorPickerCloseButton'){
				if(subDiv==thisObj){
					...
					img.src = "../theme/OWSManager/images/tab_right_active.gif"
					...
					img.src = "../theme/OWSManager/images/tab_right_inactive.gif";
					if(activeColorDiv)
	...
	function createColorPickerTopRow(inputObj){
		...
		for(var no=0;no<tabs.length;no++){			
			...
			tabImg.src = "../theme/OWSManager/images/tab_right_" + suffix + ".gif";
	...
	function showColorPicker(inputObj,formField)
	{
		if(!color_picker_div){
			...
			color_picker_div.style.display='none';
			color_picker_div.style.zIndex = 1200;
