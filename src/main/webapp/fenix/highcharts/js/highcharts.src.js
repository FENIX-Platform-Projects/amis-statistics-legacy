...
function Chart (options, callback) {
	...
	var Legend = function(chart) {
		...
		var horizontal = options.layout === 'horizontal',
			...
			// MODIFIED (this is for the rightPadding between an item and another...) 
			// rightPadding = 20,
			rightPadding = 5,
		...
		function renderItem(item) {
			...
			itemWidth = item.legendItemWidth =  options.itemWidth || symbolWidth + symbolPadding + bBox.width + rightPadding;
